...
final class TOTP extends OTP implements TOTPInterface
{
    ...
    public function verify(string $otp, null|int $timestamp = null, null|int $leeway = null): bool
    {
        ...
        $leeway = abs($leeway);
        $leeway < $this->getPeriod() || throw new InvalidArgumentException('The leeway must be lower than the TOTP period');
        $timestampMinusLeeway = $timestamp - $leeway;
        $timestampMinusLeeway >= 0 || throw new InvalidArgumentException('The timestamp must be greater than or equal to the leeway.');
    ...
    protected function getParameterMap(): array
    {
        return [...parent::getParameterMap(), 'period' => static function ($value): int {
            ...
            (int) $value >= 0 || throw new InvalidArgumentException('Epoch must be greater than or equal to 0.');
            return (int) $value;
        }];
    }
    /**
