...
final class Url
{
    ...
    public static function fromString(string $uri): self
    {
        ...
        foreach (['scheme', 'host', 'path', 'query'] as $key) {
            array_key_exists($key, $parsed_url) || throw new InvalidArgumentException('Not a valid OTP provisioning URI');
        }
        ...
        array_key_exists('secret', $parsedQuery) || throw new InvalidArgumentException('Not a valid OTP provisioning URI');
